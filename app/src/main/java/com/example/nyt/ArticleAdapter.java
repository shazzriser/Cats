...
public class ArticleAdapter extends RecyclerView.Adapter<ArticleAdapter.ArticleViewHolder> {
    ...
    private List<CatResponse> catToAdapt;

    public void setData(ArrayList<CatResponse> catToAdapt) {
    ...
    public void onBindViewHolder(@NonNull ArticleViewHolder holder, int position) {
        ...
        final CatResponse catAtPosition = catToAdapt.get(position);

        holder.headlineTextView.setText(catAtPosition.getName());
        holder.summaryTextView.setText(catAtPosition.getDescription());
        ...
        holder.shareImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra(Intent.EXTRA_TEXT, catAtPosition.getName());
...
//        }
    ...
    public static class ArticleViewHolder extends RecyclerView.ViewHolder {
        ...
        public ArticleViewHolder(View v) {
            ...
            view = v;
            headlineTextView = v.findViewById(R.id.newsHeadline);// cat name
            summaryTextView = v.findViewById(R.id.newsDetails);// description
            shareImageView = v.findViewById(R.id.newsShareButton);
            //articleImageView = v.findViewById(R.id.newsPhoto); // cat image
